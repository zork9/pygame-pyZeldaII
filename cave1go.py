...
class Cave1GO(Gameobject,CommonGO):
    "Game object"
	...
	# default width and height 
        ...
        self.SCREENH = 300
        self.SCREENW = 300
        self.image = pygame.image.load('./pics/caveentrance-1-16x16.bmp').convert()
        self.image.set_colorkey((0,0,0)) 
        self.hitpoints = 1
        # NOTE : decrease 1 hitpoint with default sword
        self.hitf = self.hit1
       	self.changeroomnumber = 5 
	...
	player.y-room.relativey > self.y and 
	player.y-room.relativey < self.y + self.h):
	    print "collision with Cave1GO (collidego)"
