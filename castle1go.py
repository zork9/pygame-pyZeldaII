...
class Castle1GO(Gameobject,CommonGO):
    "Game object"
	...
	# default width and height 
        ...
        self.SCREENH = 640
        self.SCREENW = 480 
        self.image = pygame.image.load('./pics/tile-castle-1-32x32.bmp').convert()
        self.image.set_colorkey((0,0,0)) 
        self.hitpoints = 1
        # NOTE : decrease 1 hitpoint with default sword
        self.hitf = self.hit1
       	self.changeroomnumber = 6 
	...
	player.y-room.relativey > self.y and 
	player.y-room.relativey < self.y + self.h):
	    print "collision with Castle1GO (collidego)"
