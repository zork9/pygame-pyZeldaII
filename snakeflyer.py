...
class SnakeDigDogger(EnemyFlyer):
    "Flying Eye Chain"
	...
	EnemyFlyer.__init__(self, xx, yy,ww,hh,hp)
        ...
        self.bodyimage = pygame.image.load('./pics/digdogger1.bmp').convert()
        self.bodyimage.set_colorkey((0,0,255)) 
...
##        sleep(.1) # FIX goblin sleep
        ...
        self.x -= 2
        self.yy = sin(self.angle)*20+self.y
        screen.blit(self.bodyimage, (self.x+room.relativex,self.yy+room.relativey))
        self.angle += self.PI/8
        self.yy = sin(self.angle)*20+self.y
        screen.blit(self.bodyimage, (self.x-10+room.relativex,self.yy+room.relativey))
        self.angle += self.PI/8
        self.yy = sin(self.angle)*20+self.y
        screen.blit(self.bodyimage, (self.x-20+room.relativex,self.yy+room.relativey))
        self.angle += self.PI/8
        self.yy = sin(self.angle)*20+self.y
        screen.blit(self.bodyimage, (self.x-30+room.relativex,self.yy+room.relativey))

        self.angle += self.PI/8
        self.x -= 10
        self.yyy = sin(self.angle)*20+self.y
        screen.blit(self.headimage, (self.x-40+room.relativex,self.yyy+self.y+room.relativey))
        self.angle -= self.PI/8
        self.angle -= self.PI/8
        self.angle -= self.PI/8
